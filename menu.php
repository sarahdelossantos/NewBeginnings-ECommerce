...
$content.=<<<END
						<li><a href="<?php echo $uri; ?>sort=LowtoHigh">Price Low to High</a></li>
						<li><a href="<?php echo $uri; ?>sort=HightoLow">Price High to Low</a></li>
						<li><a href="<?php echo $uri; ?>sort=NewArrivals">New Arrivals</a></li>
